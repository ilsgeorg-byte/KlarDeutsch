...
# Ограничения частоты запросов для конкретных эндпоинтов
# Ограничение для эндпоинта аутентификации (чтобы предотвратить brute-force атаки)
limiter.limit("5 per minute")(auth_bp)

# Ограничение для эндпоинтов, связанных с AI (чтобы предотвратить чрезмерное использование)
limiter.limit("20 per minute")(ai_enrich_bp)

# Ограничение для эндпоинтов аудио (чтобы предотвратить чрезмерную загрузку файлов)
limiter.limit("10 per minute")(audio_bp)

# Ограничения для других эндпоинтов
limiter.limit("100 per hour")(words_bp)
